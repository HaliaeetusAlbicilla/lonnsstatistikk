function getRes() {
    ...
    // alert(aarsUtbet);
    // alert(toUkers);
    document.getElementById("aar").innerHTML = "<strong>Din årlige utbetaling før skatt:</strong> <br />" + aarsUtbet.toLocaleString() + " kr";
    document.getElementById("toUke").innerHTML = "<strong>Din utbetaling hver 14. dag før skatt:</strong> <br />" + toUkers.toLocaleString() + " kr";
