...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 5, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [-77299.000000, 6448400.010000, 1115103.360000, 7939978.000000],
            units: 'degrees'})
    })
});
...
map.getView().fit([-77299.000000, 6448400.010000, 1115103.360000, 7939978.000000], map.getSize());
